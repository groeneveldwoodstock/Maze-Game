...
public class LoseMenu extends GameState {
	...
	public LoseMenu(GameStateManager manager) {
		super(manager);
	...
	protected void render(Graphics graphics) {
		...
		graphics.drawString("You Lost!", 15, 350);
		graphics.drawString("Select Start to Try Again!", 15, 400);
		graphics.drawImage(Resources.TEXTURES.get(Resources.ENEMY), 575, 20, Tile.SIZE*4, Tile.SIZE*4, null);
