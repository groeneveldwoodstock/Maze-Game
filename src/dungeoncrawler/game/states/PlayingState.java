...
public class PlayingState extends GameState {
	...
	protected void render(Graphics graphics) {
		...
		graphics.drawString(this.player.getArmor()+ " Armor", Tile.SIZE*2/3+85, 20);
		graphics.drawImage(Resources.TEXTURES.get(Resources.GOLD), 180, 0, Tile.SIZE*2/3, Tile.SIZE*2/3, null);
		graphics.drawString(this.player.getGold()+" Gold", Tile.SIZE*2/3+180, 20);
		graphics.drawImage(Resources.TEXTURES.get(Resources.CHEST), 625, 0, Tile.SIZE*1/2, Tile.SIZE*2/3, null);
		graphics.drawString(this.player.getChests()+ "/"+ " 12 Chests Found", Tile.SIZE*1/2+625, 20);
		graphics.drawString(this.player.getBats()+ "/"+ " 35 Bats Killed", Tile.SIZE*2/3+625, 425);
	}
